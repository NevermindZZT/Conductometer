...
- 新增数据操作对话框的等待可被任意按键终止
 ...
 #### 2018/5/16 0.9-Beta
- 新增可执行设置项，可添加函数至设置列表，短按确认键执行
- 新增稳恒态加热盘温度的保存，上位机以同步更改
- 代码优化
- 正式版预告

 #### 2018/5/17 1.0
- 第一个正式版固件
- 修复设置界面，执行可执行设置项之后出现设置项错位的问题
- 修复Flash中没有数据时，查询数据时死循环的问题
- 新增数据显示加热稳恒态加热盘温度的显示，界面调整
- 修改数据擦除为只擦除数据控制块，减少Flash擦除频率
